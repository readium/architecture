...
consoleStyles.textContent = "#console{width: 100%;min-height: 100vh;white-space: pre-wrap;word-wrap: break-word;-webkit-tab-size: 2;-moz-tab-size: 2;-ms-tab-size: 2;tab-size: 2;}#console span{display: block;margin-top: 16px;}";
